  ...
  return (
    <footer className="bg-[#255F38] text-white py-10">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Company Info */}
        <div>
          <h2 className="text-2xl font-bold text-white mb-4">ForestWatch</h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300 text-sm">
            ...
            <li>Address: ForestWatch HQ, Dhaka, Bangladesh</li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-[#1F7D53] mt-10 pt-6 text-center text-gray-400 text-xs">
        &copy; {new Date().getFullYear()} ForestWatch. All rights reserved.
      </div>
    </footer>
  );
};
